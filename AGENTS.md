# AGENTS.md — Chuva Bot Task Management System
...
For detailed package structure, see .Codex/skills/architecture/SKILL.md
For database schema details, see .Codex/skills/database/SKILL.md
For API endpoint catalog, see .Codex/skills/api/SKILL.md
