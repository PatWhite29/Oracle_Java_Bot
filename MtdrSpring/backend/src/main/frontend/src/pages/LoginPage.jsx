...
export default function LoginPage() {
  ...
  return (
    <>
      ...
      <p className="text-sm text-gray-500 mb-5 leading-relaxed">Sign in to your project workspace</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div className="flex justify-end -mt-1">
          <span className="text-xs text-navy-mid font-medium cursor-pointer hover:underline">Forgot password?</span>
        </div>
      ...
      <p className="text-center text-sm text-gray-500 mt-4">
        No account?{' '}
        <Link to="/register" className="text-navy-mid font-semibold hover:underline">Create account</Link>
      </p>
    </>
  );
}
