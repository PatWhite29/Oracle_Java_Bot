...
CREATE USER kairobot IDENTIFIED BY kairobot123 DEFAULT TABLESPACE USERS TEMPORARY TABLESPACE TEMP;
GRANT CONNECT, RESOURCE, UNLIMITED TABLESPACE TO kairobot;
ALTER SESSION SET CURRENT_SCHEMA = kairobot;
